...
const comparison: { label: string; luga: CellValue; erp: CellValue; planilha: CellValue }[] = [
  ...
  { label: "Boletos integrados", luga: "check", erp: "partial", planilha: "cross" },
  ...
  { label: "Implantação rápida", luga: "check", erp: "cross", planilha: "check" },
  { label: "Multi-usuário sem extra", luga: "check", erp: "partial", planilha: "cross" },
];
    ...
    <section className="bg-white py-20" id="por-que-luga">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-14">
          ...
          <h2 className="section-title">Por que a Luga ERP?</h2>
          <p className="section-subtitle mt-4 max-w-2xl mx-auto">
            Compare e veja por que a Luga é a escolha certa para distribuidoras
            e atacadistas que buscam eficiência sem pagar caro.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection delay={100}>
          ...
          <div className="mt-3 flex items-center gap-4 text-xs text-luga-text-secondary px-1">
            <span className="flex items-center gap-1"><MinusCircle size={12} className="text-amber-400" /> Custo extra</span>
